...
type Config struct {
	App    app    `yaml:"app" env-prefix:"SEGMENT_" json:"app"`
	Listen listen `yaml:"listen" env-prefix:"SEGMENT_LISTEN_" json:"listen"`
	Log    Logger `yaml:"log" env-prefix:"SEGMENT_" json:"log"`
}
